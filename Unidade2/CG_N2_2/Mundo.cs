  ...
  public class Mundo : GameWindow
  {
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      if (estadoTeclado.IsKeyPressed(Keys.Space))
      {
        ...
        PrimitiveType[] valores = new PrimitiveType[]
        {
          PrimitiveType.Lines,
        ...
        int indiceAtual = Array.IndexOf(valores, objetoSelecionado.PrimitivaTipo);
        int proximoIndice = (indiceAtual + 1) % valores.Length;
        objetoSelecionado.PrimitivaTipo = valores[proximoIndice];
      }

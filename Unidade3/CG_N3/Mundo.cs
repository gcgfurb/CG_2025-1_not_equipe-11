...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    private static double moveDistance = 0.05;
    private static double scaleDistance = 0.1;
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      {
        objetoSelecionado.MatrizTranslacaoXYZ(-moveDistance, 0, 0);
        // objetoSelecionado.MatrizGlobalInversa(new Ponto4D(-moveDistance, 0, 0));
      }
      ...
      if (estadoTeclado.IsKeyPressed(Keys.Up) && objetoSelecionado != null)
        objetoSelecionado.MatrizTranslacaoXYZ(0, moveDistance, 0);
      ...
      if (estadoTeclado.IsKeyPressed(Keys.PageUp) && objetoSelecionado != null)
        objetoSelecionado.MatrizEscalaXYZ(1 + scaleDistance, 1 + scaleDistance, 1 + scaleDistance);
      ...
      if (estadoTeclado.IsKeyPressed(Keys.Home) && objetoSelecionado != null)
        objetoSelecionado.MatrizEscalaXYZBBox(1 + scaleDistance, 1 + scaleDistance, 1 + scaleDistance);
      ...
      if (estadoTeclado.IsKeyPressed(Keys.D1) && objetoSelecionado != null)
        objetoSelecionado.MatrizRotacao(rotationAngle);
      ...
      if (estadoTeclado.IsKeyPressed(Keys.D3) && objetoSelecionado != null)
        objetoSelecionado.MatrizRotacaoZBBox(rotationAngle);
      ...
      if (MouseState.IsButtonPressed(MouseButton.Right))
      {
        ...
        if (objetoNovo != null)
        {
          ponto = objetoNovo.MatrizGlobalInversa(ponto);
          objetoNovo.PontosAlterar(ponto, objetoNovo.PontosListaTamanho - 1);
          objetoNovo.PontosAdicionar(ponto);  
          return;
        }

        Objeto objetoPai = (objetoSelecionado != null) ? objetoSelecionado : mundo;
        ponto = objetoPai.MatrizGlobalInversa(ponto);
        objetoNovo = new Poligono(objetoPai, ref rotuloAtual, new List<Ponto4D> { ponto, ponto });
      ...
      if (MouseState.IsButtonDown(MouseButton.Right))
      {
        ...
        {
          sruPonto = objetoNovo.MatrizGlobalInversa(sruPonto);
          objetoNovo.PontosAlterar(sruPonto, objetoNovo.PontosListaTamanho - 1);
        }
      }
